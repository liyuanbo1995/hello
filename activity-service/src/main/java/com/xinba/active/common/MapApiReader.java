package com.xinba.active.common;
...
public class MapApiReader implements ParameterBuilderPlugin {
    ...
    private final static String basePackage = "com.simba.active.in.swagger.model.";  //动态生成的Class名
     ...
     */
    private CtField createField(ApiJsonProperty property, CtClass ctClass) throws ChangeSetPersister.NotFoundException, CannotCompileException, NotFoundException {
